%% RK4Demo.m
%% Overview
% This script illustrates the use of the classical fourth-order Runge-Kutta
% method (implemented in the function |RK4.m|) for the problem 
%
...
for N=Nvalues
    ...
    legend('RK4 solution','RK4 points');
    pause
    ...
    legend('RK4 solution','RK4 points', 'Exact Solution');
    hold off
    if N<Nvalues(end)
        pause
    end
